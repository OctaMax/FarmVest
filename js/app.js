(() => {
    ...
    (() => {
        ...
        function windowload() {
            ...
            let userTheme;
            if (window.matchMedia) userTheme = window.matchMedia("(preferes-color-scheme: dark)").matches ? "dark" : "light";
            window.matchMedia("(preferes-color-scheme: dark)").addEventListener("change", (e => {
            ...
            function changeTheme(saveTheme = false) {
                let currrentTheme = htmlBlock.classList.contains("light") ? "light" : "dark";
                let newTheme;
                if (currrentTheme === "light") newTheme = "dark"; else if (currrentTheme === "dark") newTheme = "light";
                htmlBlock.classList.remove(currrentTheme);
